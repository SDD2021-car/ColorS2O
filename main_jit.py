...
def get_args_parser():
    ...
    parser.add_argument('--hint_train_path', default='/data/yjy_data/SAM2/hint_outputs_train/color_hint_by_dots', type=str,
                        help='Optional path to color hint images for training')
    parser.add_argument('--hint_test_path', default='/data/yjy_data/SAM2/hint_outputs_test/color_hint_by_dots', type=str,
                        help='Optional path to color hint images for inference')
    parser.add_argument('--class_num', default=1, type=int)

    # checkpointing
    parser.add_argument('--output_dir', default='/NAS_data/hjf/JiTcolor/checkpoints/SAR2Opt/caJiT_CP/round4/Sparse_color_Modulator_concat_sam2_loss_bs8',
    ...
    parser.add_argument('--sync_cuda_every_step', default=True,
